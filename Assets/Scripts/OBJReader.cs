...
public sealed class FastObjImporter
{
    ...
    public Mesh ImportFile(string filePath,Vector3 offset)
    {
        ...
        for (int i = 0; i < text.Length; i++)
        {
            if (text[i] == '\n')
            {
                ...
                else if (sb[0] == 'v' && sb[1] == ' ') // Vertices
                {
                    int splitStart = 2;
                    float x, y, z;
                    x = GetFloat(sb, ref splitStart, ref sbFloat);
                    z = GetFloat(sb, ref splitStart, ref sbFloat);
                    y = GetFloat(sb, ref splitStart, ref sbFloat);
