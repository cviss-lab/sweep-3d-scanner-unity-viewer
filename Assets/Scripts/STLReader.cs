...
public class STLReader
{
    ...
    /**
        ...
        */
    public static Mesh[] Import(string path,Vector3 pos_offset)
    {
        try
        {
            return ImportBinary(path,pos_offset);
        }
    ...
    private static Mesh[] ImportBinary(string path, Vector3 pos_offset)
    {
